...
const unsigned char select_[] PROGMEM = {
  ...
  delay(0);
	...
	switch(gamestate) {
		...
		case 1: //Title Screen
			...
			drawBitmap(10 + 41 * pointer, 46, select_, 26, 16, WHITE, NORMAL);
			...
			break;
		case 2: //Char Select		
			drawBitmap(96, 2, select_, 26, 16, WHITE, NORMAL);
			if(playerselect == 1) {
		...
		case 4: //Game Over
			if(h1 > h2) {
				...
				drawBitmap(51, 29, select_, 26, 16, WHITE, NORMAL);

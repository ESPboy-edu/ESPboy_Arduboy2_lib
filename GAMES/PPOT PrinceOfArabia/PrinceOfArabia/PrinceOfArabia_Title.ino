...
void setTitleFrame(TitleFrameIndex index) {
    ...
    FX::seekDataArray(TitleFrameIndexTable, idx, 0, /*sizeof(uint24_t)*/3 + sizeof(uint8_t));
    uint32_t data = FX::readPendingLastUInt32();
    FX::setFrame((/*uint24_t*/ uint32_t )(data >> 8), (uint8_t)data);
